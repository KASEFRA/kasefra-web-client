 ...
 * Single-step form for investment accounts (no type-specific details)
 */
...
export function CreateInvestmentDialog({
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      toast.error(
        error.response?.data?.detail || 'Failed to create investment account'
      )
    } finally {
        ...
        <DialogHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <DialogDescription>
                Add a new investment or retirement account
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Brokerage/Institution</FormLabel>
                  <FormControl>
                    <Input
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Current account value</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
